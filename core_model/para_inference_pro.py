...
class HybridDecoder(nn.Module):
    def __init__(self, latent_dim=201*6, init_channels=1024):  # 400x400 output
        super().__init__()
        ...
        self.deconv_layers = nn.Sequential(
            # 8x8 -> 16x16
            ResidualUpBlock(init_channels, 768),  # 增加通道数
            SelfAttention(768),  # 新增注意力
            
            # 16x16 -> 32x32
            ResidualUpBlock(768,512),
            SelfAttention(512),

            ResidualUpBlock(512,128),
...
def train_model(gpu_num):
    ...
    model_path = "/data/group_003/yjh/best_designer_model.pth"
    final_model_path = "/data/group_003/yjh/final_designer_model.pth"
...
if __name__ == "__main__":
    train_model(gpu_num=2)
    #  ce loss 可以达到0.1740，但是加大模型参数带来的效果似乎并不是非常显著
