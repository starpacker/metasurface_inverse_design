...
class OptimizedDecoder(nn.Module):
    ...
    def forward(self, x):
        batch_size_TEMP, _,_ = x.shape
        x = x.view(batch_size_TEMP, -1)  # Flatten the last two dimensions
        x = self.fc(x)
...
# pattern = torch.load('D:/subject/physics/AI4S/project1/tensor_data_2000/tensor_data_matrix2000.pt')
# spectrum = torch.load('D:/subject/physics/AI4S/project1/tensor_data_2000/tensor_spectrum2000.pt')
pattern = torch.load("D:/starpacker/metasurface_inverse_design-main/dataset/tensor_data_2000/tensor_data_2000/tensor_data_matrix2000.pt")
spectrum = torch.load("D:/starpacker/metasurface_inverse_design-main/dataset/tensor_data_2000/tensor_data_2000/tensor_spectrum2000.pt")
...
def train_model():
    ...
    model_path = f"D:/starpacker/metasurface_inverse_design-main/best_designer_model_{now_time}.pth"
    final_model_path = f'D:/starpacker/metasurface_inverse_design-main/final_designer_model_{now_time}.pth'
