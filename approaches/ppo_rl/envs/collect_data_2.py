...
def reward(data,alpha=0.2,base=0.8,beta=0.2):
    ...
    # if r_lr[wave_l] < 0.05 and r_rr_now < 0.03:
    #     reward += rl_lr * 3
    # if r_lr[wave_l] < 0.03 and r_rr_now < 0.02:
    #     reward += rl_lr * 3
    # if r_lr[wave_l] < 0.02 and r_rr_now < 0.01:
    #     reward += rl_lr * 3
    # if r_lr[wave_l] < 0.005 and r_rr_now < 0.005:
    #     reward += r_rr * 6
    # if r_lr[wave_l] < 0.01 and r_rr_now < 0.004:
    #     reward += r_rr * 3
    # if r_lr[wave_l] < 0.005 and r_rr_now < 0.003:
    #     reward += r_rr * 3
    # if r_lr[wave_l] < 0.002 and r_rr_now < 0.002:
        # reward += r_rr * 3
