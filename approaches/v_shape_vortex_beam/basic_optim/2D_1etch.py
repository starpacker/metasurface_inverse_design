...
params_nominfeat = "pid_optim_nominfeat.json"
...
sim_2d_nominfeat = "pid_grating_coupler_2D_nominfeat.fsp"
...
if __name__ == "__main__":    
    if min_feature_size == 0:
        ...
        result_file = params_nominfeat
        sim_file = sim_2d_nominfeat
    else:
        params_file = params_nominfeat
